...
def _screen_require_config(config: Mapping[str, object]) -> None:
    ...
    if config.get("schema") != "cach.av1b.vendor_gdn_bridge_review300.config.v1":
...
def run_av1b_screen(
    ...
    *,
    ...
    if not final_action_jvp.finite:
        raise FloatingPointError("step300 local action-condition JVP is non-finite")
    ...
    return {
        "schema": "cach.av1b.vendor_gdn_bridge_review300.screen.v1",
        "validity": {
