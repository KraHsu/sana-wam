#!/usr/bin/env python
"""Fail-closed 8-GPU supervisor/worker for the R5 LIBERO formal epoch."""
...
CONFIG_RELATIVE_PATH = "configs/experiments/libero_formal_r5_8gpu_epoch2.yaml"
RUN_NONCE = "b9c0140b5431ac7f9bad96efd5a03192"
RUN_ROOT = Path(
...
PREDECESSOR_R5_ROOT = Path(
    ...
    "9b5098afc038e06eb1f47f20bf82ab32"
)
PREDECESSOR_R5_RESULT_SHA256 = "421e8a13f63cf652a8554947ddc0a9cd051efd00a0e2c82986a3e3a53063741c"
PREDECESSOR_R5_CHECKPOINT_SHA256 = (
    "0e28f8706676e49dd37d9713e8689f27a876a99498094570372294beace7e1aa"
)
FORMAL40_RESULT = Path(
    "/DATA/share/sana_wam_libero_evaluation/r5_causal1_formal40/"
    "libero-r5-causal1-formal40-63ed23a0dfa595e84bf85e174bb340e5/FORMAL_RESULT.json"
)
FORMAL40_RESULT_SHA256 = (
    "e6107a275aac3806dc901cf198ccadb03bf00343451b6330af65ea75a9cad5ac"
)
K8_AB_RESULT = Path(
...
EXPECTED_DATASET_WINDOWS = 10_520
EXPECTED_FINAL_STEP = 1_315
...
def _verify_config():
    ...
    exact = {
        ...
        "training.scientific_predecessor_k28_formal40_result_sha256": FORMAL40_RESULT_SHA256,
        ...
        "training.video_lr": 5.0e-5,
        "training.action_lr": 5.0e-5,
...
def _verify_predecessors() -> dict[str, Any]:
    ...
    if (
        ...
        != "LIBERO_AR_R5_8GPU_EPOCH1_TRAINING_COMPLETE"
    ...
    return {
        "r5_r2_result": result,
        "r5_r2_checkpoint": checkpoint,
        "scientific_k28_formal40": formal40,
...
def _prepare_root_parent() -> None:
    ...
    namespace_paths = (
        ...
        Path("/DATA/share/sana_wam_libero_training/formal_epoch2_r5"),
    )
...
def _worker(args: argparse.Namespace) -> None:
    if os.environ.get("SANA_WAM_R5_SUPERVISED_WORKER") != "1":
        ...
        if rank == 0:
            try:
                ...
                worker_result_sha256 = _exclusive_json(
                    ...
                    {
                        "schema_version": "sana-wam-libero-r5-worker-result-v1",
    ...
    try:
        with _supervisor_signal_guard():
            ...
            attempt_sha256 = _exclusive_json(
                ...
                {
                    "schema_version": "sana-wam-libero-r5-attempt-v1",
            ...
            environment.update(
                {
                    ...
                    "PYTHONUNBUFFERED": "1",
                    "SANA_WAM_R5_SUPERVISED_WORKER": "1",
            ...
            result = {
                "schema_version": "sana-wam-libero-r5-result-v1",
                "valid_run": True,
                "verdict": "LIBERO_AR_R5_8GPU_EPOCH2_SUCCESSOR_TRAINING_COMPLETE",
                "execution_result": "PASS",
                ...
                "training": {
                    **summary,
                    ...
                    "predecessor_r5_uniform_optimizer_steps": 1315,
                    "r5_uniform_optimizer_steps": EXPECTED_FINAL_STEP,
        ...
        if root_created and not success_committed:
            ...
            _publish_failure(
                {
                    "schema_version": "sana-wam-libero-r5-failure-v1",
                    "valid_run": False,
